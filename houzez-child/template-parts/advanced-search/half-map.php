...
<div class="advanced-search houzez-adv-price-range">
    ...
    <form autocomplete="off" method="get" class="save_search_form" action="#">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="form-group">
                    <select name="bedrooms" class="selectpicker" data-live-search="false" data-live-search-style="begins" title="">
                        <option value=""><?php echo _e( 'Комнат', 'houzez' ); ?></option>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo isset ( $_GET['min-area'] ) ? $_GET['min-area'] : ''; ?>" name="min-area" placeholder="<?php echo _e( 'Площадь от', 'houzez' ); ?>">
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo isset ( $_GET['max-area'] ) ? $_GET['max-area'] : ''; ?>" name="max-area" placeholder="<?php echo _e( 'Площадь до', 'houzez' ); ?>">
                </div>
            </div>
            <?php } ?>
