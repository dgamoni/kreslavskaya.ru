                ...
                <div class="houzez-module">
                    ...
                    <div class="list-tabs table-list full-width">
                        ...
                        <?php 
                            //$status = 'for-sale';
                            //$status = 'for-rent';
                            $status = get_post_meta( get_the_ID(), 'fave_status', true );
                            //var_dump($status);
                            ...
                            //var_dump($query_args->post_count);
                            $postcount = $query_args->post_count;
                            
                        ?>
                            <h2 class="tabs-title"><?php the_title(); ?><?php echo ' (<span id="postcount">' .$postcount. '</span>)'; ?></h2>
                        </div>
                    ...
                    <div class="property-listing <?php echo esc_attr($listing_view); ?>">
                        <div class="row">
                            <div id="houzez_ajax_container" data-slug="<?php echo $post->post_name; ?>">
